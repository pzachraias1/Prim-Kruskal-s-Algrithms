...
class main {
    public static void main(String[] arg) {
        ...
        numTest = intCheckTest(temp);// pass in string to the method and return an integer. it check if the string is integer or not.
    ...
    /**
     * This method is going to check if the random generate coordinate is already been enter. 
     * to make sure that all freckle are at different coordinate. There is no way for a freckle 
    ...
    /**
     * it is going to parse the input into integer and check if integer is between 1 and 100
    ...
    public static int intCheckTest(String s) {
        ...
        // loop around when input is not a integer or if the parse input integer is greater than 100
     ...
     * @param s input from the user
     * @return boolean. If input is integer, return true. If input is not, return false
     */
    public static boolean checkInt(String s) {
        ...
        try {
            ...
            //when the Integer.parseInt false, it will throw except and will change boolean to false
